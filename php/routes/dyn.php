...
<html lang="pt-BR">
    <head>
        ...
        <link href="scripts/dependencies/data-tables/datatables.css" rel="stylesheet"/>
        <script src="scripts/dependencies/fontawesome-5.13.0/js/all.js"></script>
    </head>
    <body id="body" class="sb-nav-fixed sb-nav-toggled">
        ...
        <script src="scripts/dependencies/jquery-3.5.1/jquery-3.5.1.js?"></script>
        <script src="scripts/dependencies/bootstrap-4.5.0-dist/js/bootstrap.bundle.js"></script>
        <script src="scripts/dependencies/chartjs/chart.bundle.js"></script>
        <script src="scripts/dependencies/chartjs/chart-rounded-corners.js"></script>
        <script src="scripts/dependencies/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js"></script>
        <script src="scripts/dependencies/data-tables/DataTables-1.10.21/js/jquery.dataTables.js"></script>
        <script src="scripts/dependencies/data-tables/DataTables-1.10.21/js/dataTables.bootstrap4.js"></script>
        <script src="scripts/dependencies/moment-develop/moment.js"></script>
