import type { As, Is, And, Types, PrimaryTypes, UnusualTypes, TypeGuard, TypeGuardLike, Guards, SuperGuard, Callable, Extra, Has, KeyOf, ArgOf, TypeOf, Type } from './types.js';
...
export declare function has<K extends KeyOf = KeyOf, T extends Types = Types, O extends Extra = {}>(obj: {}, key: K | K[], typeName?: T | T[], _oref?: O): obj is Has<K, Type<T>, O>;
