...
declare type TypeOfIterator<V extends unknown, C extends boolean> = As<ValueOf<{
    [P in PrimaryTypes | UnusualTypes]: As<Type<P> extends infer T ? unknown extends T ? undefined : C extends true ? Equal<T, V> extends true ? P : undefined : V extends T ? P : never : never>;
}>>;
...
export declare type Has<K extends KeyOf, T extends ValueOf = ValueOf, O extends {} = {}> = As<And<{
    [P in K]: T;
} & O>>;
